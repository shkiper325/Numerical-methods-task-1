...
def exact_solution(x):
    if x <= 0.5:
        ...
        return (-0.11188827105317398*(-26.513559170900876 + 5.449489742783178*2.718281828459045**(1.4142135623730951*x) + 14.696938456699067*2.718281828459045**(0.4082482904638631 + 1.4142135623730951*x) - 0.5505102572168221*2.718281828459045**(0.816496580927726 + 1.4142135623730951*x) - 2.905547372312596*2.718281828459045**(1.1700499715209998 + 1.4142135623730951*x) + 2.0650153761645464*2.718281828459045**(0.35355339059327373*(1. + 4.*x))))/2.718281828459045**(0.2357022603955158*(4.732050807568877 + 3.*x))
